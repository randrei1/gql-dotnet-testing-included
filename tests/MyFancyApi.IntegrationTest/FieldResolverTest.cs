...
{
    public class FieldResolverTest : IClassFixture<WebApplicationFactory<MyFancyApi.Service.Startup>>, IAsyncLifetime
    {
        private readonly WebApplicationFactory<MyFancyApi.Service.Startup> _factory;
        private readonly ITestOutputHelper _testOutputHelper;

        public FieldResolverTest(WebApplicationFactory<MyFancyApi.Service.Startup> factory, ITestOutputHelper testOutputHelper)
        {
        ...
        [Fact]
        public async Task AuthorHasBook()
        {
            ...
            var graphQLResponse = await graphQLClient.SendQueryAsync<AuthorResponse>(BookQueryWithVariables);
            _testOutputHelper.WriteLine(JsonConvert.SerializeObject(graphQLResponse));
            Assert.True(graphQLResponse.Data.author.Books.Any());
        }
